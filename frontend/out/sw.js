const CACHE='seringa-v4';
const BASE='./';
self.addEventListener('install',event=>event.waitUntil(caches.open(CACHE).then(c=>c.addAll([BASE,'./index.html','./styles.css?v=4.0','./app.js?v=4.0','./manifest.webmanifest'])).then(()=>self.skipWaiting())));
